...
class Stores(models.Model):
    ...
    description = models.CharField(max_length=250, null=True)
    logo_url = models.URLField(null=True, blank=True)
    background_color = models.CharField(max_length=7, default='#ffffff',null=True)
    foreground_color = models.CharField(max_length=7, default='#ffffff',null=True)
    background_img = models.ImageField(upload_to='media',null=True)
    ttf_font = models.CharField(max_length=100, null=True, blank=True)
