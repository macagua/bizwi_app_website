# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2016-02-11 14:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_joined', models.DateTimeField(default=datetime.datetime(2016, 2, 11, 14, 10, 16, 580466), editable=False)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='services.Cities')),
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='services.Countries')),
                ('region', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='services.Regions')),
            ],
            options={
                'db_table': 'stores',
            },
